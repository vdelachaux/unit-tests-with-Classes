...
//MARK:-try
$ut.suite("try")
ASSERT:C1129($ut.test("Text").expect("hello world").try.isEqualTo("hello").latest.failed; "Should failed")
ASSERT:C1129($ut.test("Null").expect("hello world").try.isEqualTo(Null:C1517).latest.failed; "Should failed")
ASSERT:C1129($ut.test("Numeric").expect(2).try.isEqualTo(1).latest.failed; "Should failed")
ASSERT:C1129($ut.test("Null").expect(Null:C1517).try.isEqualTo(New object:C1471).latest.failed; "Should failed")
ASSERT:C1129($ut.test("Boolean").expect(True:C214).try.isEqualTo(False:C215).latest.failed; "Should failed")
ASSERT:C1129($ut.test("Picture").expect($picture).try.isEqualTo($picture*0).latest.failed; "Should failed")
ASSERT:C1129($ut.test("Date").expect(!1958-08-08!).try.isEqualTo(!00-00-00!).latest.failed; "Should failed")
ASSERT:C1129($ut.test("Time").expect(?00:00:00?).try.isEqualTo(?01:01:01?).latest.failed; "Should failed")
ASSERT:C1129($ut.test("Object").expect(New object:C1471).try.isEqualTo(Null:C1517).latest.failed; "Should failed")
ASSERT:C1129($ut.test("Object").expect($object).try.isEqualTo(New object:C1471).latest.failed; "Should failed")
ASSERT:C1129($ut.test("Object").expect(New object:C1471).try.strict().isEqualTo(New object:C1471("foo"; "BAR")).latest.failed; "Should failed")
ASSERT:C1129($ut.test("Collection").expect(New collection:C1472).try.isEqualTo($collection).latest.failed; "Should failed")
ASSERT:C1129($ut.test("Collection").expect(New collection:C1472).try.isEqualTo(Null:C1517).latest.failed; "Should failed")
ASSERT:C1129($ut.test("Collection").expect($collection).try.strict().isEqualTo(New collection:C1472(1; 2; "FOO")).latest.failed; "Should failed")
ASSERT:C1129($ut.test("Pointer").expect($pointer).try.isEqualTo(Get pointer:C304("foo")).latest.failed; "Should failed")
ASSERT:C1129($ut.test("Pointer").expect($pointer).try.isEqualTo(Get pointer:C304("")).latest.failed; "Should failed")
ASSERT:C1129($ut.test("Pointer").expect($pointer).try.isEqualTo(New object:C1471).latest.failed; "Should failed")
...
$ut.test("mistmatch").try.expect($real).isEqualTo("33")
